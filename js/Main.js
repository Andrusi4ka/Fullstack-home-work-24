...
console.log(skillsManager.addSkill('II'));
console.log(skillsManager.addSkill('HTML'));
console.log(skillsManager.addSkill(9));
console.log(skillsManager.getAllSkills());

console.log('Список навичок: ' + skillsManager.red(skillsManager.skills));
